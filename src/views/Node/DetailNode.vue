  ...
  <div>
    <v-card class="ma-4 pb-6 white--text" color="grey lighten-4">
      ...
      <v-card class="mx-16 my-6 px-12 py-6">
          ...
          <v-tab-item v-for="item in table" :key="item" class="pb-4">
            ...
            <template v-if="item.kode == 'pH'">
              <DatePicker
                ...
                :dateEnd="dateEnd"
                :showChart="showChart"
                :showThisDayChart="showThisDayChart"
              ...
              <template>
                <v-alert dense type="error">
                  Jika nilai {{ item.kode }} ada diatas garis merah, berarti
                  nilai {{ item.kode }}
                  terlalu tinggi
                </v-alert>
                <v-alert dense type="warning">
                  Jika nilai {{ item.kode }} ada dibawah garis kuning, berarti
                  nilai {{ item.kode }}
                  terlalu rendah
                </v-alert>
              </template>
        ...
        <v-tabs-items v-model="tab" class="mt-6"> </v-tabs-items>
      </v-card>
    </v-card>
  </div>
</template>
  ...
  methods: {
    ...
    showChart() {
      ...
      axios
        ...
        .get(
          "http://182.255.0.149/API_Tambak/public/api/tambak/between/" +
